!(function (t, e) {
  ...
  function gt(t, e) {
    ...
    e.showConfirmButton || e.showDenyButton || e.showCancelButton || st(a),
      ...
      (r = e).buttonsStyling
        ...
        : yt([n, o, i], X.styled),
      e.reverseButtons &&
        (a.insertBefore(l, s), a.insertBefore(u, s), a.insertBefore(c, s)),
      F(s, e.loaderHtml),
      W(s, e, 'loader');
  }
  var vt,
    ...
    At = function (t) {
      ...
      ft()
        ...
        : (((r = document.createElement('div')).className = X.container),
          ...
          (r = i),
          'rtl' === window.getComputedStyle(r).direction && bt(k(), X.rtl),
          (t = E()),
          (a = wt(t, X.input)),
          (e = wt(t, X.file)),
  ...
  function Ot(t, e) {
    ...
    i &&
      ...
      'string' == typeof (n = e.backdrop)
        ...
        : n || bt([document.documentElement, document.body], X['no-backdrop']),
      !e.backdrop &&
        e.allowOutsideClick &&
        K(
  ...
  var zt = function () {
    ...
    Yt = function (t, e) {
      (t.textContent = ''),
        e.iconHtml
          ...
          : F(t, Qt({ question: '?', warning: '!', info: 'i' }[e.icon]));
    },
    Zt = function (t, e) {
      if (e.iconColor) {
    ...
    $t = function (t, e) {
      (t.className = ''
        ...
        e.toast
          ? (bt([document.documentElement, document.body], X['toast-shown']),
            bt(t, X.toast))
          : bt(t, X.modal),
        W(t, e, 'popup'),
    ...
    for (var e in t)
      ae((o = e)) || K('Unknown parameter "'.concat(o, '"')),
        t.toast &&
          ((n = e),
          -1 !== pe.indexOf(n) &&
            K('The parameter "'.concat(n, '" is incompatible with toasts'))),
        se((n = e)) && v(n, se(n));
    var n, o;
  }
  var ue = {
    ...
    fe = Object.freeze({
      ...
      bindClickHandler: function () {
        (ie[
          ...
          oe || (document.body.addEventListener('click', re), (oe = !0));
      },
    });
  function me() {
    var t, e;
  ...
  var be = function () {
    ...
    we = function (t) {
      ...
      return (
        ...
        !ke(t) &&
        (e === n ||
          !(lt(n) || 'INPUT' === e.tagName || (lt(E()) && E().contains(e))))
      );
    },
    Ce = function (t) {
      return (
  ...
  function He(t) {
    var e = x();
    t.target === e &&
      ((t = k()), e.removeEventListener(Pt, He), (t.style.overflowY = 'auto'));
  }
  function Ve(t, e) {
  ...
  var Ne = ['swal-title', 'swal-html', 'swal-footer'],
    ...
    Ye = function (e) {
      ...
      g(e.querySelectorAll('*')).forEach(function (t) {
        t.parentNode === e &&
          ...
          -1 === n.indexOf(t) && K('Unrecognized element <'.concat(t, '>')));
      });
    },
    Ze = function (e, n) {
    ...
    Xe = function (t, e, n) {
      bt(t, n.showClass.backdrop),
        ...
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          bt([document.documentElement, document.body], X['height-auto']);
    },
    Ge = function (t) {
    ...
    xn = function (n, o, i) {
      o.container.onclick = function (t) {
        ...
        Cn
          ? (Cn = !1)
          : t.target === o.container && Q(e.allowOutsideClick) && i(J.backdrop);
      };
    };
  function Bn(t, e) {
    var n = (function (t) {
      ...
      Ae.swalPromiseResolve.set(a, t),
        ...
        (s.denyButton.onclick = function () {
          return (
            (e = c),
            (t = a).disableButtons(),
            void (e.returnInputValueOnDeny ? cn(t, e, 'deny') : ln(t, e, !1))
          );
          var t, e;
        }),
        ...
        (r = s),
        (t = e),
        Lt.innerParams.get(n).toast ? wn(n, r, t) : (kn(r), An(r), xn(n, r, t)),
        (o = a),
        (r = c),
        (i = e),
        (t = ne).keydownTarget &&
        ...
        (c.toast && (c.input || c.footer || c.showCloseButton) ? bt : yt)(
          document.body,
          X['toast-column']
        ),
        (r = a),
  ...
  var On = function (t, e, n) {
    ...
    Sn = function (t, e) {
      if (!e.toast)
        return Q(e.allowEnterKey) ? void (Tn(t, e) || Re(0, -1, 1)) : Ln();
    },
    Tn = function (t, e) {
      ...
      showValidationMessage: function (t) {
        ...
        F(e.validationMessage, t),
          ...
          n.customClass &&
            ...
            bt(e.validationMessage, n.customClass.validationMessage),
